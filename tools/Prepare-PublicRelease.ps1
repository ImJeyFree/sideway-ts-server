...
$publicFiles=@(
 ...
 'include/RtpStreamer.h','include/RtspStreamer.h','include/QualityConfig.h','include/WireProtocol.h','include/Common.h','include/TsBroadcaster.h','include/TunerClient.h','include/ScanClient.h','include/ChannelStore.h','include/HttpStreamer.h','include/UdpStreamer.h','include/TrayApp.h','include/WebDashboard.h','include/third_party/json.hpp',
 'src/RtpStreamer.cpp','src/RtspStreamer.cpp','src/main.cpp','src/TrayApp.cpp','src/HttpStreamer.cpp','src/UdpStreamer.cpp','src/TsBroadcaster.cpp','src/TunerClient.cpp','src/ChannelStore.cpp',
 'sdk/TunerCoreApi.h','tests/RuntimeTests.cpp','tests/StreamTests.cpp','tests/DashboardTests.js','tests/MockTunerCore.cpp','tests/LoaderTests.cpp',
 'docs/DLL_API.md','docs/안정성_보강_2026-09-18.md','docs/EPG_API.md','docs/공개_배포_범위.md','docs/변경_기록.md','tools/Prepare-PublicRelease.ps1'
)
...
foreach($folder in @($runtime,$sdk)){
 foreach($f in @('LICENSE','NOTICE','BINARY_LICENSE.md','THIRD_PARTY_NOTICES.md','licenses/nlohmann-json-MIT.txt','README.md','docs/DLL_API.md','docs/안정성_보강_2026-09-18.md','docs/EPG_API.md','docs/공개_배포_범위.md','docs/변경_기록.md')){Copy-Relative $root $f $folder}
}
