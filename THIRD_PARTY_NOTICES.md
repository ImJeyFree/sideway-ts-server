...
- 원본: https://github.com/nlohmann/json/tree/v3.11.3
- 포함 파일: include/third_party/json.hpp
- 라이선스: MIT. 원본 고지와 [라이선스 전문](licenses/nlohmann-json-MIT.txt)을 함께 보존합니다.
...
Microsoft Visual C++ 런타임 설치가 필요할 수 있습니다. 해당 런타임은 Microsoft의 배포 조건을 따르며 본 패키지에는 포함하지 않습니다.
